...
User _userDeserialize(
  ...
  final object = User(
    createAt: reader.readLong(offsets[0]),
    ...
    lastSeen: reader.readLongOrNull(offsets[5]),
  );
  return object;
}
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastSeenEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastSeen',
        value: value,
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, int?, QQueryOperations> lastSeenProperty() {
    return QueryBuilder.apply(this, (query) {
